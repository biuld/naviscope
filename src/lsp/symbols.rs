...
fn build_symbol_tree(
    ...
    crate::parser::DocumentSymbol {
        ...
        kind: node.kind(),
        range: node.range().cloned().unwrap_or(crate::model::graph::Range {
            start_line: 0,
            start_col: 0,
            end_line: 0,
            end_col: 0,
...
fn convert_symbols(
    symbols: Vec<crate::parser::DocumentSymbol>,
    parser: &dyn crate::parser::LspParser,
) -> Vec<DocumentSymbol> {
    symbols
        .into_iter()
...
fn convert_symbol(
    sym: crate::parser::DocumentSymbol,
    parser: &dyn crate::parser::LspParser,
) -> DocumentSymbol {
    let range = Range {
